...
#endif
/* Always include sched.h — some vendor 4.x kernels keep put_task_struct here */
...
/*
 * TWA_SIGNAL / TWA_RESUME were introduced in kernel 5.9.
 * On 4.19 and older, task_work_add() takes a plain bool:
 *   false = no notification (equivalent to TWA_RESUME)
 *   true  = send signal    (equivalent to TWA_SIGNAL)
 */
